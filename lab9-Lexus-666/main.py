...
SQLALCHEMY_DATABASE_URL = "postgresql://postgres:admin@localhost:5432/laba_9"
...
def create_user_form():
    return FileResponse(path="public/create_user.html")
...
def read_user_form():
    return FileResponse(path="public/read_user.html")
...
def update_user_form():
    return FileResponse(path="public/update_user.html")
...
def update_user(id=Form(), new_username=Form(), new_email=Form(), new_password=Form()):
    try:
        ...
        session.commit()
        response = JSONResponse(content={"message": "user updated"})
        session.close()
        return response
    except Exception as e:
        return JSONResponse(content={"message": str(e)})
...
def delete_user_form():
    return FileResponse(path="public/delete_user.html")
...
def create_post_form():
    return FileResponse(path="public/create_post.html")
...
def create_post(title=Form(), content=Form(), user_id=Form()):
    try:
        ...
        session.add(post)
        session.commit()
        response = JSONResponse(content={"message": "post created"})
        session.close()
        return response
    except Exception as e:
        return JSONResponse(content={"message": str(e)})
...
def read_post_form():
    return FileResponse(path="public/read_post.html")
...
def update_post_form():
    return FileResponse(path="public/update_post.html")
...
def update_post(id=Form(), new_title=Form(), new_content=Form(), new_user_id=Form()):
    try:
        ...
        session.commit()
        response = JSONResponse(content={"message": "post updated"})
        session.close()
        return response
    except Exception as e:
        return JSONResponse(content={"message": str(e)})
...
def delete_post_form():
    return FileResponse(path="public/delete_post.html")
...
def delete_post(id=Form()):
    try:
        ...
        session.delete(post)
        session.commit()
        response = JSONResponse(content={"message": "post deleted"})
        session.close()
        return response
    except Exception as e:
        return JSONResponse(content={"message": str(e)})
